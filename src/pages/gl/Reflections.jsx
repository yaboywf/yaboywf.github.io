    ...
    return (
        <div className={styles.reflections}>
            ...
            <div>
                ...
                <article>
                    Across the semester, PPMR framework provided a structured way for me to develop my learning journey while responding to facilitator feedback. Instead of treating each phase as separate, I gradually learned to view them as a continuous cycle that informed my decisions and improvements.
                    <br /><br />
