        ...
        <section className="certs">
            ...
            <div>
                ...
                <div className='certs_list'>
                    {content.map(contentItem => <input key={contentItem} type="radio" name="certs" id={contentItem} onChange={() => setCertIndex(parseInt(contentItem))} checked={certIndex === parseInt(contentItem)} />)}
                </div>
            </div>
        </section>
    );
