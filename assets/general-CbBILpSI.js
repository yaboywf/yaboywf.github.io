import{A as j,y as N,d as G,x as W,B as X,e as Y,M as k,a as J}from"./vendor-BuZh7iWQ.js";const K=["#ffffff","#ffffff","#ffffff"],Q=t=>{t=t.replace(/^#/,""),t.length===3&&(t=t.split("").map(s=>s+s).join(""));const i=parseInt(t,16),u=(i>>16&255)/255,l=(i>>8&255)/255,r=(i&255)/255;return[u,l,r]},U=`
